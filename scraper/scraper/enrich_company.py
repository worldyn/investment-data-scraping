...
def prep_company_name(company_name):
    ...
    if '/' in company_name: # remove second company, e.g kuoni group / vfs global to kuoni group
...
def main():
    parser = argparse.ArgumentParser(description='Enrich individual companies with organisational and \
    ...
    parser.add_argument('-g', '--organisation', required=True, type=str, help='json file with organisational data')
    parser.add_argument('-f', '--funding', required=True, type=str, help='json file with funding data')
